...
def main(params):
    ...
    df_create.tpep_pickup_datetime = pd.to_datetime(df_create.tpep_pickup_datetime)
    df_create.tpep_dropoff_datetime = pd.to_datetime(df_create.tpep_dropoff_datetime)
